...
export default class AccountAllowanceApproveTransaction extends Transaction {
     ...
     * @returns {AccountAllowanceApproveTransaction}
     */
    addAllTokenNftAllowance(tokenId: TokenId | string, spenderAccountId: AccountId | string): AccountAllowanceApproveTransaction;
    /**
     * @override
     * @protected
     * @returns {proto.ICryptoApproveAllowanceTransactionBody}
     */
    protected override _makeTransactionData(): proto.ICryptoApproveAllowanceTransactionBody;
}
