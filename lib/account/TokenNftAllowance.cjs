...
class TokenNftAllowance {
  ...
  static _fromProtobuf(allowance) {
    return new TokenNftAllowance({
      ...
      serialNumbers: allowance.approvedForAll != null && allowance.approvedForAll.value ? null : allowance.serialNumbers != null ? allowance.serialNumbers.map(serialNumber => _long.default.fromValue(serialNumber)) : []
    });
  }
  /**
   * @internal
