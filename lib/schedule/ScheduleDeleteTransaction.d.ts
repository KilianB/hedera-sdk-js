...
export default class ScheduleDeleteTransaction extends Transaction {
     ...
     */
    static _fromProtobuf(transactions: proto.ITransaction[], signedTransactions: proto.ISignedTransaction[], transactionIds: TransactionId[], nodeIds: AccountId[], bodies: proto.ITransactionBody[]): ScheduleDeleteTransaction;
    /**
     * @param {object} [props]
     ...
     */
    protected override _makeTransactionData(): proto.IScheduleDeleteTransactionBody;
}
export namespace proto {
    ...
    type IScheduleDeleteTransactionBody = import("@hashgraph/proto").IScheduleDeleteTransactionBody;
