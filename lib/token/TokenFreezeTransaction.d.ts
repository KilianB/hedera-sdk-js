...
export default class TokenFreezeTransaction extends Transaction {
     ...
     */
    static _fromProtobuf(transactions: proto.ITransaction[], signedTransactions: proto.ISignedTransaction[], transactionIds: TransactionId[], nodeIds: AccountId[], bodies: proto.ITransactionBody[]): TokenFreezeTransaction;
    /**
     * @param {object} [props]
     ...
     */
    protected override _makeTransactionData(): proto.ITokenFreezeAccountTransactionBody;
}
export namespace proto {
    ...
    type ITokenFreezeAccountTransactionBody = import("@hashgraph/proto").ITokenFreezeAccountTransactionBody;
