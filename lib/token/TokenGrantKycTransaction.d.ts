...
export default class TokenGrantKycTransaction extends Transaction {
     ...
     */
    static _fromProtobuf(transactions: proto.ITransaction[], signedTransactions: proto.ISignedTransaction[], transactionIds: TransactionId[], nodeIds: AccountId[], bodies: proto.ITransactionBody[]): TokenGrantKycTransaction;
    /**
     * @param {object} [props]
     ...
     */
    protected override _makeTransactionData(): proto.ITokenGrantKycTransactionBody;
}
export namespace proto {
    ...
    type ITokenGrantKycTransactionBody = import("@hashgraph/proto").ITokenGrantKycTransactionBody;
