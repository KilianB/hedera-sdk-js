...
export default class TokenUnpauseTransaction extends Transaction {
     ...
     */
    static _fromProtobuf(transactions: proto.ITransaction[], signedTransactions: proto.ISignedTransaction[], transactionIds: TransactionId[], nodeIds: AccountId[], bodies: proto.ITransactionBody[]): TokenUnpauseTransaction;
    /**
     * @param {object} [props]
     ...
     */
    protected override _makeTransactionData(): proto.ITokenUnpauseTransactionBody;
}
export namespace proto {
    ...
    type ITokenUnpauseTransactionBody = import("@hashgraph/proto").ITokenUnpauseTransactionBody;
