...
class TopicMessage {
  ...
  static _ofSingle(response) {
    ...
    const payerAccountIdProto = response.chunkInfo?.initialTransactionID?.accountID;
    const payerAccountId = payerAccountIdProto ? _AccountId.default._fromProtobuf(payerAccountIdProto) : null;
    const transactionIdProto = response.chunkInfo?.initialTransactionID;
    const transactionId = transactionIdProto ? _TransactionId.default._fromProtobuf(transactionIdProto) : null;
  ...
  static _ofMany(responses) {
    ...
    const payerAccountIdProto = responses[0].chunkInfo?.initialTransactionID?.accountID;
    const payerAccountId = payerAccountIdProto ? _AccountId.default._fromProtobuf(payerAccountIdProto) : null;
